...
namespace Capitulo001.Data.Dal.Cadastro
{
    public class DepartamentoDAL
    {
        ...
        {
            return _context.Departamentos.Include(d => d.Instituicao).OrderBy(b => b.Nome);
        }
        ...
        public async Task<Departamento> GravaDepartamento(Departamento departamento)
        {
