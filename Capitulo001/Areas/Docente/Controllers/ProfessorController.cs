using Capitulo001.Areas.Docente.Models;
using Capitulo001.Data;
using Capitulo001.Data.Dal.Cadastro;
using Capitulo001.Data.Dal.Docente;
...
namespace Capitulo05.Areas.Docente.Controllers
{
    ...
    public class ProfessorController : Controller
    {
        ...
        {
            //instituicoes = instituicaoDAL.ObterInstituicoesClassificadaPorNome().ToList();
        ...
        {
            //var institutos = instituicaoDAL.ObterInstituicoesClassificadaPorNome().ToList();
            //var departamentos = departamentoDAL.ObterDepartamentoClassificadosPorNome().ToList();
            ...
            PrepararViewBags(instituicaoDAL.ObterInstituicoesClassificadaPorNome().ToList(),
